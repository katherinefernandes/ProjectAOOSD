...
class FilterByJourneyIDtest {
	...
	@Test
	void testFilterByJourneyID() {
		Container c1 = new Container( 232383l,3344l, 780l,36l ,  234l,  10.0f,  19.0f,  "cargo",  10.0f,  1.0f,  60.0f, "10-09-2021");
		Container c2 = new Container( 6283l,3202l, 781l, 38l,  102l,  10.0f,  19.0f,  "cargo",  10.0f, 1.0f,  78.0f, "10-09-2021");
